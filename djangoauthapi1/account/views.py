...
class UserChangePasswordView(APIView):
    ...
    def post(self,request,format=None):
        ...
        serializer.is_valid(raise_exception=True)   #if is not needed exception automatically dealt with 
        return Response({'msg':'Password Changed successfully'},  #by the default exception handler in REST framework and returns http 404 bad request
